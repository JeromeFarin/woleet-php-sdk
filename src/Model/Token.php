 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Token implements ModelInterface, ArrayAccess, \Stringable
{
     ...
     * Sets token
     *
     * @param string $token The JWT token value to provide in the `Bearer` scheme of the `Authorization` header.
     *
     * @return $this
     */
